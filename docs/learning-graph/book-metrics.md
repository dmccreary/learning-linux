...
|---|---------|-------|--------|-------|
| 1 | Concepts | 550 | Required | Concepts from learning graph |
...
| 5 | Chapter Quizzes | 26 / 27 | Recommended | Chapters with a quiz.md (260 questions total) |
| 6 | Chapter References | 0 / 27 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 541 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 66 | Recommended | Questions in faq.md |
| 9 | Words | 139,481 | Required | Words across student-facing markdown |
...
| Equations | 319 | 280 | LaTeX expressions (inline and display) |
| Total Words | 139,481 | 108,670 | Words in markdown files |
| Links | 1090 | 893 | Hyperlinks in markdown format |
| Equivalent Pages | 581 | 457 | Estimated pages (250 words/page + visuals) |
